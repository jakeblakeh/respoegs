...
var prefix = ".";
var token = "NDY2MjMyMTc0MDEwNjk1Njkw.DiZHfQ.QDergpYNBgSCj4sq6FMwEjkTQ0o";

client.on("ready", () => {
  console.log("RecruitMC | Logged in! Server count: ${client.guilds.size}");
  client.user.setGame(`RecuitMC Tickets | .new`);
});

client.on("guildCreate", (guild) => {
client.user.setGame(`RecuitMC Tickets | .new`);
    guild.owner.user.send(`Hello! I'm RecruitMC\nThanks for adding me to your guild!`);
});
...
client.on("message", (message) => {
  ...
  if (message.content.toLowerCase().startsWith(prefix + `help`)) {
    ...
    .addField(`Other`, `[${prefix}help]() > Shows you this help menu your reading\n[${prefix}ping]() > Pings the bot to see how long it takes to react\n[${prefix}about]() > Tells you all about RecruitMC coming soon`)
...
client.login('NDY2MjMyMTc0MDEwNjk1Njkw.DiZHfQ.QDergpYNBgSCj4sq6FMwEjkTQ0o');
